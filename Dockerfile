# Stage 1: Compile all Java servlets with Tomcat dependencies
...
# Compile Java source files using Tomcat's lib and webapp's lib
...
# Stage 2: Final Tomcat Runtime Image
FROM tomcat:9-jdk17-temurin

# Disable Tomcat shutdown port to stop health-check conflicts
...
# Copy third-party JARs (MySQL driver, etc.) if present
